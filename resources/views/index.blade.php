...
<paper-material class="nav" elevation="1">
    <paper-tabs no-slide>
        ...
        <paper-tab><a href="#" class="nav-link">Новини</a></paper-tab>
        <paper-tab><a href="#" class="nav-link">Про училище</a></paper-tab>
        <paper-tab><a href="#" class="nav-link">Абітурієнтам</a></paper-tab>
